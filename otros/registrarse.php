        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-md-5 relative align-self-center">
                    <form action="registro.php" method="POST" class="bg-white rounded pb_form_v1">
                        ...
                        <div class="form-group">
                            <input type="submit" name="enviarregistro"
                                class="btn btn-primary btn-lg btn-block pb_btn-pill  btn-shadow-blue" value="Registrar">
                        </div>
                        <p></p>
