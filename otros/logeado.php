...
<body data-spy="scroll" data-target="#pb-navbar" data-offset="200">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="probootstrap-navbar">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a class="nav-link" href="#section-features">Galería</a></li>
  ...
  <section class="pb_cover_v3 overflow-hidden cover-bg-indigo cover-bg-opacity text-left pb_gradient_v1 pb_slant-light"
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-md-6">
          <h2 class="heading mb-3">Bienvenidos</h2>
          <div class="sub-heading">
            <p class="mb-4">En esta nuestra página podrás compartir tus mejores imágenes para así mostrarle al mundo tu
              afición.</p>
            <p class="mb-5"><a class="btn btn-success btn-lg pb_btn-pill smoothscroll" href="#section-features"><span
                  class="pb_font-14 text-uppercase pb_letter-spacing-1">Dale un vistazo</span></a></p>
          </div>
        </div>
  ...
  <!-- Sobre nosotros -->
  <section class="pb_section pb_pb-220" id="section-reviews">
    <div class="container">
      <div class="row justify-content-center mb-1">
        <div class="col-md-6 text-center mb-5">
          <h5 class="text-uppercase pb_font-15 mb-2 pb_color-dark-opacity-3 pb_letter-spacing-2"><strong>Sobre
              Nosotros</strong></h5>
          <h2>¿Quiénes somos?</h2>
        </div>
      </div>
            ...
            <div class="pb_slider_content js-pb_slider_content2">
              ...
              <div class="media d-block text-center testimonial_v1 pb_quote_v2">
                <div class="media-body">
                  <blockquote class="mb-5">Somos un par de aficionados a la fotografía al igual que muchos que visitan
                    nuesta página web que deseamos compartir las mejores fotografías de todos vosotros y así inspirar
                    a muchos otros.</blockquote>
                </div>
              </div>
            </div>
          </div>
